...
#define STATUS_SUCCESS					 0000000000

int main() {

	// create a file with winapi//kernel32
	HANDLE hFile = CreateFile(
		L"C:\\users\\Theod\\Desktop\\winapi.txt",
		GENERIC_WRITE,
		0,
		NULL,
		OPEN_ALWAYS,
	...
	// filename
	RtlInitUnicodeString(&filename, L"\\??\\C:\\Users\\Theod\\Desktop\\syscall.txt");
